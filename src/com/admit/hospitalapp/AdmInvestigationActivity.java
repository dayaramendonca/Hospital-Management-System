...
public class AdmInvestigationActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != intent)
        patient_id_here = intent.getStringExtra(TAG_PATIENT_ID);
	...
	public class LoadInvestigation extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(AdmInvestigationActivity.this);
