...
public class DoctorAdmissionsActivity extends ListActivity {
	...
	// testing on Emulator:
	private static final String ALL_PATIENTS_URL = "http://www.digitechlab.in/hospitallogin/admissions_by_doctor.php";
	...
	private static final String TAG_ADMISSION_ID = "admission_id";
...
//            });   
	...
	public void addComment(View v) {
		Intent i = new Intent(DoctorAdmissionsActivity.this, HospitalActivity.class);
		startActivity(i);
	}
	...
	public void updateJSONdata() {
		...
		try {
			...
			params.add(new BasicNameValuePair("doctor_id",consulting_doctor_id ));

			Log.d("request!", "starting");
			// getting product details by making HTTP request
			JSONObject json = jsonParser.makeHttpRequest(ALL_PATIENTS_URL, "POST",
					params);
...
//	
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(DoctorAdmissionsActivity.this);
