...
public class CurrentAdmissionsActivity extends ListActivity {
	...
	// testing on Emulator:
	private static final String ALL_PATIENTS_URL = "http://www.digitechlab.in/hospitallogin/currentadmissions.php";
...
//            });   
	...
	public void addComment(View v) {
		Intent i = new Intent(CurrentAdmissionsActivity.this, CopyAdminActivity.class);
		startActivity(i);
	}
...
//	
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CurrentAdmissionsActivity.this);
